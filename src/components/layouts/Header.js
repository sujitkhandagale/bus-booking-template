...
function Header() {
  return (
    ...
    <div className="text-right">
      Find Us : <a href="https:youtube.com"><i className="fa-brands fa-facebook"></i>&nbsp;</a>
       ...
       <nav className='navbar'>
         ...
         <div className="nav-menu">
          ...
          <ul className='flex text-right float-right'>
            ...
            <li>
              <Link className='' to={'/'}>Track Shippment</Link>
            </li>
            <li>
<span><Link to="/sign-in">Login</Link>/<Link to="/signup">Register</Link></span>
            </li>
          </ul>
